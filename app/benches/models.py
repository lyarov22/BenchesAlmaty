...
class BenchType(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = 'Типы скамеек'
...
class BenchDistrict(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = 'Районы скамеек'
...
class BenchEnvironment(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = 'Окружения скамеек'
...
class Bench(models.Model):
    ...
    has_backrest = models.BooleanField(default=False, blank=True)
    has_bin = models.BooleanField(default=False, blank=True)
    ...
    class Meta:
        verbose_name = "Скамейка"
        verbose_name_plural = "Скамейки"
